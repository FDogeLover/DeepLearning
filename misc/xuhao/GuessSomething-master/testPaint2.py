...
class Canvas(QWidget):
    ...
    def __init__(self, height=500, width=500):
        ...
        # 撤销按钮
        self.revokeButton = QPushButton(qtawesome.icon('mdi.undo', color='grey'), '', self)
        self.revokeButton.move(450, 0)
        self.revokeButton.clicked.connect(self.revoke)

        # 清空按钮
        self.refreshButton = QPushButton(qtawesome.icon('mdi.refresh', color='grey'), '', self)
        ...
        self.colorButton.setIcon(qtawesome.icon('mdi.circle', color=QColor(self.color)))
